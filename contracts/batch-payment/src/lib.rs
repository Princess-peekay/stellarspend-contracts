#![no_std]
//! # StellarSpend batch-payment contract
//!
...
//! ## Scope
//!
//! These are the only entry points the crate currently exposes. The
//! multi-recipient transfer API described in this crate's `README.md`
//! (`batch_transfer`, `Payment`, `BatchPaymentContract`) is not implemented
//! here; this module documents what the code does, not what the README
//! plans.
